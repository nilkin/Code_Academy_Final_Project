...
namespace ZoNaN.Data.Migrations
{
    ...
    [Migration("20201202223344_addColumnToProductPhotochange2")]
    partial class addColumnToProductPhotochange2
    {
            ...
            modelBuilder.Entity("ZoNaN.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 12, 3, 2, 33, 43, 819, DateTimeKind.Local).AddTicks(9169));
            ...
            modelBuilder.Entity("ZoNaN.Models.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date")
                        .HasDefaultValue(new DateTime(2020, 12, 3, 2, 33, 43, 830, DateTimeKind.Local).AddTicks(4974));
            ...
            modelBuilder.Entity("ZoNaN.Models.ProductPhoto", b =>
                {
                    ...
                    b.Property<string>("IsFirstPhoto")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("False");

                    b.Property<string>("IsSecondPhoto")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("False");
            ...
            modelBuilder.Entity("ZoNaN.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 12, 3, 2, 33, 43, 844, DateTimeKind.Local).AddTicks(8123));
